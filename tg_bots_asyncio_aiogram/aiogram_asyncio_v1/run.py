...
async def cmd_send_image(message: Message):
    await message.answer_photo(photo='https://ichef.bbci.co.uk/news/976/cpsprodpb/16620/production/_91408619_55df76d5-2245-41c1-8031-07a4da3f313f.jpg',
                               caption='описание')


# Пример отправки картинок
@dp.message(F.text == '/send_audio')
async def cmd_send_image(message: Message):
    await message.answer_voice(voice='https://github.com/DanielNikitin/web_host/blob/main/like.m4a',
                               caption='описание')
