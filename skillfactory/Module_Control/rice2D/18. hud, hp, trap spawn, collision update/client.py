...
def redrawWindow(screen, players, trees, ores, traps, extra_data):
    screen.fill('gray25')
...
# -------- CLIENT KEY CONDITIONS
    ...
    try:
        ...
        while run:
            ...
            if data is not None:
                players, trees, ores, traps, extra_data = data
                ...
                redrawWindow(screen, players, trees, ores, traps, extra_data)
